...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(11, "Otworz", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(12, "Zapisz", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(13, "Zakoncz program", "", wx.ITEM_NORMAL)
        self.Snakereader_menubar.Append(wxglade_tmp_menu, "Plik")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(21, "Slowniki", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(22, "Dane techniczne", "", wx.ITEM_NORMAL)
        self.Snakereader_menubar.Append(wxglade_tmp_menu, "Opcje")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(31, "Rozpoznaj", "", wx.ITEM_NORMAL)
        self.Snakereader_menubar.Append(wxglade_tmp_menu, "Rozpoznaj")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(41, "Dokumentacja", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(42, "Wymagania", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(43, "O programie", "", wx.ITEM_NORMAL)
        self.Snakereader_menubar.Append(wxglade_tmp_menu, "Pomoc")
        # Menu Bar end
        
        # Tool Bar
        self.Snakereader_toolbar = wx.ToolBar(self, -1)
        self.SetToolBar(self.Snakereader_toolbar)
        self.Snakereader_toolbar.AddLabelTool(51, u"Otwórz", wx.Bitmap("C:\\Documents and Settings\\Kasia dom\\Moje dokumenty\\Moje obrazy\\Snake\\snake1.jpg", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.Snakereader_toolbar.AddLabelTool(52, "Rozpoznaj", wx.Bitmap("C:\\Documents and Settings\\Kasia dom\\Moje dokumenty\\Moje obrazy\\Snake\\snake1.jpg", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.Snakereader_toolbar.AddLabelTool(53, "Zapisz", wx.Bitmap("C:\\Documents and Settings\\Kasia dom\\Moje dokumenty\\Moje obrazy\\Snake\\snake1.jpg", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.Snakereader_toolbar.AddLabelTool(54, "Opcje", wx.Bitmap("C:\\Documents and Settings\\Kasia dom\\Moje dokumenty\\Moje obrazy\\Snake\\snake1.jpg", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        # Tool Bar end
